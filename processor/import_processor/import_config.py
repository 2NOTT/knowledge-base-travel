...
class ImportConfig:
    ...
    travel_model: str = field(
        default_factory=lambda: os.getenv("TRAVEL_MODEL", "")
    )
    ...
    travel_entities_collection: str = field(
        default_factory=lambda: os.getenv("TRAVEL_ENTITIES_COLLECTION", "")
    )
